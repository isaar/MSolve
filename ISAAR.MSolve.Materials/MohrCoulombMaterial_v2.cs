...
{
    public class MohrCoulombMaterial_v2 : IIsotropicContinuumMaterial3D_v2
    {
        ...
        public MohrCoulombMaterial_v2(double youngModulus, double poissonRatio, double cohesion, double friction, double dilation)
        {
        ...
        public object Clone()
        {
            ...
            var m = new MohrCoulombMaterial_v2(this.youngModulus, this.poissonRatio, this.cohesion, this.friction, this.dilation)
            {
