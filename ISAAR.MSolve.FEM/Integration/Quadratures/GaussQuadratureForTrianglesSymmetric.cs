...
namespace ISAAR.MSolve.FEM.Integration.Quadratures
{
    ...
    /// </summary>
    public sealed class GaussQuadratureForTrianglesSymmetric : IQuadrature2D
    {
        public static readonly GaussQuadratureForTrianglesSymmetric Order1Point1 = new GaussQuadratureForTrianglesSymmetric(
            new GaussPoint2D(1.0 / 3, 1.0 / 3, 1.0 / 2));

        // WARNING: Do not change their order. ExtrapolationGaussTriangular3Points depends on it.
        public static readonly GaussQuadratureForTrianglesSymmetric Order2Points3 = new GaussQuadratureForTrianglesSymmetric(
        ...
        public static readonly GaussQuadratureForTrianglesSymmetric Order2Points3Alternative = new GaussQuadratureForTrianglesSymmetric(
            new GaussPoint2D(0.0, 1.0 / 2, 1.0 / 6),
            new GaussPoint2D(1.0 / 2, 0.0, 1.0 / 6),
            new GaussPoint2D(1.0 / 2, 1.0 / 2, 1.0 / 6));
        #endregion

        public static readonly GaussQuadratureForTrianglesSymmetric Order3Points4 = new GaussQuadratureForTrianglesSymmetric(
        ...
        public static readonly GaussQuadratureForTrianglesSymmetric Order4Points7 = new GaussQuadratureForTrianglesSymmetric(
        ...
        public static readonly GaussQuadratureForTrianglesSymmetric Order4Points7Alternative = new GaussQuadratureForTrianglesSymmetric(
        ...
        public static readonly GaussQuadratureForTrianglesSymmetric Order7Points13 = new GaussQuadratureForTrianglesSymmetric(
        ...
        private GaussQuadratureForTrianglesSymmetric(params GaussPoint2D[] points)
        {
