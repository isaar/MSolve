...
namespace ISAAR.MSolve.FEM.Elements
{
    public class Hexa8NonLinearDefGrad_v2 : IStructuralFiniteElement_v2, IEmbeddedHostElement_v2
    {
        ...
        protected readonly IContinuumMaterial3DDefGrad_v2[] materialsAtGaussPoints;
        ...
        protected Hexa8NonLinearDefGrad_v2()
        {
        }

        public Hexa8NonLinearDefGrad_v2(IContinuumMaterial3DDefGrad_v2 material, IQuadrature3D quadratureForStiffness)
        {
            ...
            materialsAtGaussPoints = new IContinuumMaterial3DDefGrad_v2[nGaussPoints];
            for (int i = 0; i < nGaussPoints; i++)
                materialsAtGaussPoints[i] = (IContinuumMaterial3DDefGrad_v2)material.Clone();
        ...
        public bool MaterialModified
        {
            get
            {
                foreach (IContinuumMaterial3DDefGrad_v2 material in materialsAtGaussPoints)
        ...
        {
            foreach (IContinuumMaterial3DDefGrad_v2 material in materialsAtGaussPoints) material.ResetModified();
        }

        public void ClearMaterialState()
        {
            //TODO: the next throws an exception. Investigate. Possible changes in Analyzers may be the cause.
            //foreach (IContinuumMaterial3DDefGrad_v2 m in materialsAtGaussPoints) m.ClearState();
        }
        ...
        public void SaveMaterialState()
        {
            ...
            foreach (IContinuumMaterial3DDefGrad_v2 m in materialsAtGaussPoints) m.SaveState();
        }

        public void ClearMaterialStresses()
        {
            foreach (IContinuumMaterial3DDefGrad_v2 m in materialsAtGaussPoints) m.ClearStresses();
        }
