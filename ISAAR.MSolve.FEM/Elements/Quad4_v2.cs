...
{
    public class Quad4_v2 : IStructuralFiniteElement_v2, IEmbeddedHostElement_v2
    {
        ...
        protected double[,] GetCoordinatesTranspose(Element_v2 element)
        {
        ...
        public virtual IMatrix MassMatrix(IElement_v2 element) => CalculateConsistentMass(element);
        ...
        public IMatrix CalculateConsistentMass(IElement_v2 element)
        {
            double[,] coordinates = this.GetCoordinates(element);
            GaussLegendrePoint3D[] integrationPoints = this.CalculateGaussMatrices(coordinates);
        ...
        {
            var accelerations = Vector.CreateZero(8);
        ...
        public EmbeddedNode_v2 BuildHostElementEmbeddedNode(Element_v2 element, Node_v2 node, IEmbeddedDOFInHostTransformationVector transformationVector)
        {
        ...
        private double[] GetNaturalCoordinates(Element_v2 element, Node_v2 node)
        {
