...
namespace ISAAR.MSolve.FEM.Elements
{
    public class Shell8NonLinear_v2 : IStructuralFiniteElement_v2
    {
        ...
        public InterpolationShell8_v2 Interpolation { get; }
        ...
        private void CalculateInitialConfigurationData(IElement_v2 element, out double[][] tx_i)
        {
            double[] E;
            double[] ni;
            ...
            (Matrix[] J_0inv, double[] detJ_0) =
                JacobianShell8Calculations_v2.GetJ_0invAndDetJ_0(J_0a, element.Nodes, oVn_i, nGaussPoints);
        ...
        private void CalculateStrains(IElement_v2 element, double[][] tx_i)
        {
            ...
            Matrix[] J_1 = JacobianShell8Calculations_v2.Get_J_1(nGaussPoints, tx_i, tU, J_0a);
            Matrix[] DefGradTr;
            Matrix[] GL;
        ...
        private void UpdateCoordinateData(double[] localdisplacements, Element_v2 element, out double[][] tx_i)
        {
