...
namespace ISAAR.MSolve.FEM.Interpolation
{
    ...
    /// </summary>
    public abstract class IsoparametricInterpolation2DBase_OLD: IIsoparametricInterpolation2D_OLD
    {
        ...
        protected IsoparametricInterpolation2DBase_OLD(CellType2D cellType, int numFunctions)
        {
        ...
        /// </summary>
        public EvalInterpolation2D_OLD EvaluateAllAt(IReadOnlyList<Node2D> nodes, NaturalPoint2D naturalPoint)
        {
            ...
            return new EvalInterpolation2D_OLD(shapeFunctions, naturalShapeDerivatives, 
                new IsoparametricJacobian2D_OLD(nodes, naturalShapeDerivatives));
        }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation2D.EvaluateAllAtGaussPoints(IReadOnlyList{Node2D}, IQuadrature2D)"/>.
        /// </summary>
        public IReadOnlyList<EvalInterpolation2D_OLD> EvaluateAllAtGaussPoints(IReadOnlyList<Node2D> nodes, IQuadrature2D quadrature)
        {
            ...
            var interpolationsAtGPs = new EvalInterpolation2D_OLD[numGPs];
            for (int gp = 0; gp < numGPs; ++gp)
            {
                interpolationsAtGPs[gp] = new EvalInterpolation2D_OLD(shapeFunctionsAtGPs[gp],
                    naturalShapeDerivativesAtGPs[gp], new IsoparametricJacobian2D_OLD(nodes, naturalShapeDerivativesAtGPs[gp]));
            }
