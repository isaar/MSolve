...
{
    public class InterpolationHexa8ReverseNew
    {
        private static readonly InterpolationHexa8ReverseNew uniqueInstance = new InterpolationHexa8ReverseNew();

        public static InterpolationHexa8ReverseNew UniqueInstance => uniqueInstance;
        ...
        public (double[,] Ni_ksi, double[,] Ni_heta, double[,] Ni_zeta, double[] a_123g) GetShapeFunctionDerivatives(int gp_d1_disp, int gp_d2_disp, int gp_d3_disp)
        {
            ...
            //GaussLegendre3D quadrature = GaussLegendre3D.GetQuadratureWithOrder(1, 1, 1);
            //IReadOnlyList < double[,]> formality = GetShapeFunctionNaturalDerivatives(quadrature);
            //double[,] formality2 = formality[0];
            //double formality3 = formality[0][0, 0];
