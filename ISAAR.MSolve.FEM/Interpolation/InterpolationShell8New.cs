...
{
    public class InterpolationShell8New : IsoparametricInterpolation3DBase
    {
        private static readonly InterpolationShell8New uniqueInstance = new InterpolationShell8New();

        private InterpolationShell8New() : base(8)
        {
        ...
        public static InterpolationShell8New UniqueInstance => uniqueInstance;
