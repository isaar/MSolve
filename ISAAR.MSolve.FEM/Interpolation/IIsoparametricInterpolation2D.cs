...
namespace ISAAR.MSolve.FEM.Interpolation
{
    ...
    public interface IIsoparametricInterpolation2D
    {
        ...
        IInverseInterpolation2D CreateInverseMappingFor(IReadOnlyList<Node_v2> nodes);
        ...
        ///     element.</param>
        EvalInterpolation2D EvaluateAllAt(IReadOnlyList<Node_v2> nodes, NaturalPoint2D naturalPoint);
        ...
        /// <see cref="EvaluateAllAt(IReadOnlyList{Node_v2}, NaturalPoint2D)"/> when the integration points of an element are
        ...
        ///     same.</param>
        IReadOnlyList<EvalInterpolation2D> EvaluateAllAtGaussPoints(IReadOnlyList<Node_v2> nodes, IQuadrature2D quadrature);
        ...
        ///     element.</param>
        CartesianPoint2D TransformNaturalToCartesian(IReadOnlyList<Node_v2> nodes, NaturalPoint2D naturalPoint);
    }
}