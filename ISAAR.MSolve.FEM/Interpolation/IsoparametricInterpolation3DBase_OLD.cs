...
{
    /// <summary>
    /// Basic implementation of <see cref="IIsoparametricInterpolation3D_OLD"/>
    /// Authors: Dimitris Tsapetis, Serafeim Bakalakos
    /// </summary>
    public abstract class IsoparametricInterpolation3DBase_OLD : IIsoparametricInterpolation3D_OLD
    {
        ...
        public IsoparametricInterpolation3DBase_OLD(int numFunctions)
        {
        ...
        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.CellType"/>.
        /// </summary>
        public CellType CellType { get; }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.NumFunctions"/>.
        /// </summary>
        public int NumFunctions { get; }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.NodalNaturalCoordinates"/>.
        /// </summary>
        public abstract IReadOnlyList<NaturalPoint3D> NodalNaturalCoordinates { get; }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.CreateInverseMappingFor(IReadOnlyList{Node3D})"/>.
        /// </summary>
        public abstract IInverseInterpolation3D CreateInverseMappingFor(IReadOnlyList<Node3D> nodes);

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateAllAt(IReadOnlyList{Node3D}, NaturalPoint3D)"/>.
        /// </summary>
        public EvalInterpolation3D_OLD EvaluateAllAt(IReadOnlyList<Node3D> nodes, NaturalPoint3D naturalPoint)
        {
            ...
            return new EvalInterpolation3D_OLD(shapeFunctions, naturalShapeDerivatives,
                new IsoparametricJacobian3D_OLD(nodes, naturalShapeDerivatives));
        }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateAllAtGaussPoints(IReadOnlyList{Node3D}, IQuadrature3D)"/>
        /// </summary>
        public IReadOnlyList<EvalInterpolation3D_OLD> EvaluateAllAtGaussPoints(IReadOnlyList<Node3D> nodes, IQuadrature3D quadrature)
        {
            ...
            var interpolationsAtGPs = new EvalInterpolation3D_OLD[numGPs];
            for (int gp = 0; gp < numGPs; ++gp)
            {
                interpolationsAtGPs[gp] = new EvalInterpolation3D_OLD(shapeFunctionsAtGPs[gp],
                    naturalShapeDerivativesAtGPs[gp], new IsoparametricJacobian3D_OLD(nodes, naturalShapeDerivativesAtGPs[gp]));
            }
            return interpolationsAtGPs;
        }

        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateFunctionsAt(NaturalPoint3D)"/>.
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateFunctionsAtGaussPoints(IQuadrature3D)"/>.
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateNaturalGradientsAt(NaturalPoint3D)".
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.EvaluateNaturalGradientsAtGaussPoints(IQuadrature3D)"/>.
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="IIsoparametricInterpolation3D_OLD.TransformNaturalToCartesian(IReadOnlyList{Node3D}, NaturalPoint3D)"/>.
        /// </summary>
