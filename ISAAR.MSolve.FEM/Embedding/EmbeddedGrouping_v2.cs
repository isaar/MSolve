...
namespace ISAAR.MSolve.FEM.Embedding
{
    public class EmbeddedGrouping_v2
    {
        ...
        public EmbeddedGrouping_v2(Model_v2 model, IEnumerable<Element> hostGroup, IEnumerable<Element> embeddedGroup, bool hasEmbeddedRotations)
        {
            this.model = model;
        ...
        public EmbeddedGrouping_v2(Model_v2 model, IEnumerable<Element> hostGroup, IEnumerable<Element> embeddedGroup)
