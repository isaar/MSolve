...
{
    public class EmbeddedNode_v2
    {
        private readonly Node_v2 node;
        private readonly Element_v2 embeddedInElement;
        private readonly IList<double> coordinates = new List<double>();
        private readonly IList<DOFType> dependentDOFs;

        public Node_v2 Node => node; 
        public Element_v2 EmbeddedInElement => embeddedInElement;
        public IList<DOFType> DependentDOFs => dependentDOFs;
        public IList<double> Coordinates => coordinates;

        public EmbeddedNode_v2(Node_v2 node, Element_v2 hostElement, IList<DOFType> dependentDOFs)
        {
            this.node = node;
        ...
        {
            EmbeddedNode_v2 e = obj as EmbeddedNode_v2;
