...
{
    public class ElementEmbedder_v2 : IElementDOFEnumerator
    {
        ...
        public ElementEmbedder_v2(Model_v2 model, Element embeddedElement, IEmbeddedDOFInHostTransformationVector transformation)
        {
            this.model = model;
