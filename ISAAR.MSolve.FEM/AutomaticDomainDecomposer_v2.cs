...
{
    public class AutomaticDomainDecomposer_v2
    {
        ...
        public AutomaticDomainDecomposer_v2(Model_v2 model, int numberOfProcessors)
        {
        ...
        private void AssignElementsRenumberedToSubdomains()
        {
            ...
            for (int i = 0; i < NumberOfProcessors; i++)
            {
                ...
                Model.SubdomainsDictionary.Add(i, new Subdomain_v2(i));
        ...
        private List<Node_v2> CalculateInterface(Dictionary<Node_v2, int> nodeWeight, bool[] isInteriorBoundaryNode, 
            List<Element_v2> ElementsRenumbered, int usedElementsCounter, int counterSubdomainElements, int counterSubdomain)
        {
