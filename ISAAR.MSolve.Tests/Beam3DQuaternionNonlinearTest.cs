...
namespace ISAAR.MSolve.Tests
{
    public class Beam3DQuaternionNonlinearTest
    {
        ...
        [Fact]
        public void CantileverZBeam3DQuaternionNonlinearTest()
        {
            VectorExtensions.AssignTotalAffinityCount();
            double youngModulus = 21000.0;
            double poissonRatio = 0.3;
            ...
            // Add nodal load values at the top nodes of the model
            model.Loads.Add(new Load() { Amount = nodalLoad, Node = model.NodesDictionary[monitorNode], DOF = DOFType.Z });
            ...
            Assert.Equal(179.02822898931663, linearSystems[1].Solution[8], 12);
        }

        [Fact]
        public void WilliamsToggleFrame()
        {
            VectorExtensions.AssignTotalAffinityCount();
            double youngModulus = 21000.0;
            double poissonRatio = 0.3;
            ...
            IList<Node> nodes = new List<Node>();
            Node node1 = new Node { ID = 1, X =   0.0, Y =  0.0, Z = 0.0 };
            Node node2 = new Node { ID = 2, X = 100.0, Y = 10.0, Z = 0.0 };
            Node node3 = new Node { ID = 3, X = 200.0, Y = 20.0, Z = 0.0 };
            Node node4 = new Node { ID = 4, X = 300.0, Y = 30.0, Z = 0.0 };
            Node node5 = new Node { ID = 5, X = 400.0, Y = 20.0, Z = 0.0 };
            Node node6 = new Node { ID = 6, X = 500.0, Y = 10.0, Z = 0.0 };
            Node node7 = new Node { ID = 7, X = 600.0, Y =  0.0, Z = 0.0 };
            ...
            model.NodesDictionary[1].Constraints.Add(DOFType.RotY);
            model.NodesDictionary[1].Constraints.Add(DOFType.RotZ);
            model.NodesDictionary[7].Constraints.Add(DOFType.X);
            model.NodesDictionary[7].Constraints.Add(DOFType.Y);
            model.NodesDictionary[7].Constraints.Add(DOFType.Z);
            model.NodesDictionary[7].Constraints.Add(DOFType.RotX);
            model.NodesDictionary[7].Constraints.Add(DOFType.RotY);
            model.NodesDictionary[7].Constraints.Add(DOFType.RotZ);
        ...
        public void LShapedBeam()
        {
            ...
            Node node7 = new Node { ID = 7, X = 500.0, Y = 0.0, Z = 100.0 };
        ...
        public void PlaneFrameTest()
        {
            ...
            for (int iElem = 0; iElem < nElems; iElem++)
            {
                // Create new Beam3D section and element
                var beamSection = new BeamSection3D(area, inertiaY, inertiaZ, torsionalInertia, effectiveAreaY, effectiveAreaZ);
                var beam = new Beam3DCorotationalQuaternion(new[] { model.NodesDictionary[iNode], model.NodesDictionary[iNode + 1] }, material, 7.85, beamSection);
            ...
            Assert.Equal(112.4912617324, linearSystems[1].Solution[0], 12);
        }
    }
}
