...
namespace ISAAR.MSolve.Tests
{
    public class IntegrationTests
    {
        ...
        //[Fact]
        private static void SolveQuadCantileverDecompositionTest4()
        {
            double youngModulus = 3.0e07;
            double poissonRatio = 0.3;
            double nodalLoad = 1000;
            ...
            model.SubdomainsDictionary.Add(0, new Subdomain(0));
            model.SubdomainsDictionary.Add(1, new Subdomain(1));
            model.SubdomainsDictionary.Add(2, new Subdomain(2));
            model.SubdomainsDictionary.Add(3, new Subdomain(3));

            model.NodesDictionary.Add(0, new Node() { ID = 0, X = 0, Y = 0, Z = 0.0 });
            model.NodesDictionary.Add(1, new Node() { ID = 1, X = 3, Y = 0, Z = 0.0 });
            model.NodesDictionary.Add(2, new Node() { ID = 2, X = 6, Y = 0, Z = 0.0 });
            model.NodesDictionary.Add(3, new Node() { ID = 3, X = 0, Y = 2, Z = 0.0 });
            model.NodesDictionary.Add(4, new Node() { ID = 4, X = 3, Y = 2, Z = 0.0 });
            model.NodesDictionary.Add(5, new Node() { ID = 5, X = 6, Y = 2, Z = 0.0 });
            model.NodesDictionary.Add(6, new Node() { ID = 6, X = 0, Y = 4, Z = 0.0 });
            model.NodesDictionary.Add(7, new Node() { ID = 7, X = 3, Y = 4, Z = 0.0 });
            model.NodesDictionary.Add(8, new Node() { ID = 8, X = 6, Y = 4, Z = 0.0 });
            ...
            model.SubdomainsDictionary[0].Elements.Add(element);
            var matrix = element.ElementType.StiffnessMatrix(element);
            Matrix<double> kmatlab = MathNet.Numerics.LinearAlgebra.CreateMatrix.Dense<double>(matrix.NumRows, matrix.NumColumns);
            for (int i = 0; i < matrix.NumRows; i++)
            {
                for (int j = 0; j < matrix.NumColumns; j++)
                {
                    kmatlab[i, j] = matrix[i, j];
                }
            }
            MatlabWriter.Write("..\\..\\..\\InputFiles\\K1.mat", kmatlab, "K1");
            ...
            element1.AddNode(model.NodesDictionary[4]);
            model.ElementsDictionary.Add(1, element1);
            model.SubdomainsDictionary[1].Elements.Add(element1);
            var matrix1 = element1.ElementType.StiffnessMatrix(element1);
            Matrix<double> kmatlab1 = MathNet.Numerics.LinearAlgebra.CreateMatrix.Dense<double>(matrix1.NumRows, matrix1.NumColumns);
            for (int i = 0; i < matrix1.NumRows; i++)
            {
                for (int j = 0; j < matrix1.NumColumns; j++)
                {
                    kmatlab1[i, j] = matrix1[i, j];
                }
            }
            MatlabWriter.Write("..\\..\\..\\InputFiles\\K2.mat", kmatlab1, "K2");
            ...
            model.SubdomainsDictionary[2].Elements.Add(element2);
            var matrix2 = element2.ElementType.StiffnessMatrix(element2);
            Matrix<double> kmatlab2 = MathNet.Numerics.LinearAlgebra.CreateMatrix.Dense<double>(matrix2.NumRows, matrix2.NumColumns);
            for (int i = 0; i < matrix2.NumRows; i++)
            {
                for (int j = 0; j < matrix2.NumColumns; j++)
                {
                    kmatlab2[i, j] = matrix2[i, j];
                }
            }
            MatlabWriter.Write("..\\..\\..\\InputFiles\\K3.mat", kmatlab2, "K3");
            ...
            element3.AddNode(model.NodesDictionary[8]);
            element3.AddNode(model.NodesDictionary[7]);
            model.ElementsDictionary.Add(3, element3);
            model.SubdomainsDictionary[3].Elements.Add(element3);
            var matrix3 = element3.ElementType.StiffnessMatrix(element3);
            Matrix<double> kmatlab3 = MathNet.Numerics.LinearAlgebra.CreateMatrix.Dense<double>(matrix3.NumRows, matrix3.NumColumns);
            for (int i = 0; i < matrix3.NumRows; i++)
            {
                for (int j = 0; j < matrix3.NumColumns; j++)
                {
                    kmatlab3[i, j] = matrix3[i, j];
                }
            }
            MatlabWriter.Write("..\\..\\..\\InputFiles\\K4.mat", kmatlab3, "K4");
