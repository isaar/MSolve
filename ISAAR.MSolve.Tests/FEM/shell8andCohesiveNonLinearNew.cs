...
{
    public static class shell8andCohesiveNonLinearNew
    {
    ...
    { 0,-3.074281618470940200e-05 }, {11,1.064926767847933800e-05 }, {23,-3.846254167902190800e-05 }, {35,-3.069737876105337200e-05 }, {39,-1.191596225032377100e-04 }};
        ...
        public static void ShellAndCohesiveRAM_11tlkShellPaktwsh(Model model)
        {
            ...
            {
                ID = 1,
                ElementType = new Shell8dispCopyGetRAM_1New(material2, GaussLegendre3D.GetQuadratureWithOrder(3, 3, 3))// 3, 3, 3
                {
                    oVn_i = VH,
                    tk = Tk_vec,
                }
            ...
            {
                ID = 2,
                ElementType = new cohesive_shell_to_hexaCopyGetEmbeRAM_11_tlkNew(material1, 3, 3,GaussLegendre2D.GetQuadratureWithOrder(3,3)) //3, 3
                {
                    oVn_i = VH,
                    tk = Tk_vec,
                    ShellElementSide = 0,
