...
namespace ISAAR.MSolve.Tests.FEM
{
    ...
    { 0,2.329148123666891800e-01 }, {11,1.745892242847826500e-04 }, {23,1.984890825094891800e-01 }, {35,-1.201717100696997300e-04 }, {47,-9.593766953486768100e-02 }};
            expectedDisplacements[1] = new Dictionary<int, double> {
    { 0,2.312129749268085100e-01 }, {11,1.832976227621136000e-04 }, {23,1.971828675655774300e-01 }, {35,-9.890823090886254200e-05 }, {47,-9.559024674611092700e-02 }};
            expectedDisplacements[2] = new Dictionary<int, double> {
    { 0,2.312128564190379400e-01 }, {11,1.833039372361662000e-04 }, {23,1.971829073503052500e-01 }, {35,-9.889271565521811200e-05 }, {47,-9.559022884187586000e-02 }};
            expectedDisplacements[3] = new Dictionary<int, double> {
    { 0,4.607459982538435500e-01 }, {11,3.749252050088749100e-04 }, {23,3.930823598857850500e-01 }, {35,-1.772467305907319700e-04 }, {47,-1.908369235967392100e-01 }};
            expectedDisplacements[4] = new Dictionary<int, double> {
    { 0,4.591105757986764200e-01 }, {11,3.830623301656938200e-04 }, {23,3.918152286679054700e-01 }, {35,-1.584825922898505400e-04 }, {47,-1.905002821626506900e-01 }};
            expectedDisplacements[5] = new Dictionary<int, double> {
    { 0,4.591104745433299800e-01 }, {11,3.830652621688969800e-04 }, {23,3.918153586144641500e-01 }, {35,-1.584690208680899700e-04 }, {47,-1.905002649158469300e-01 }};
