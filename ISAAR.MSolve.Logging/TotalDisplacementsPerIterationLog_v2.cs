...
{
    public class TotalDisplacementsPerIterationLog_v2 : IAnalyzerLog_v2
    {
        ...
        public TotalDisplacementsPerIterationLog_v2(Dictionary<int, int[]> watchDofs)
        {
        ...
        /// </summary>
        /// <param name="totalDisplacements">The total displacements for each subdomain.</param>
        public void StoreDisplacements_v2(Dictionary<int, IVector> totalDisplacements)
        {
            var currentIterDisplacements = new Dictionary<int, Dictionary<int, double>>();
            foreach (var subdomainDofsPair in watchDofs)
            {
