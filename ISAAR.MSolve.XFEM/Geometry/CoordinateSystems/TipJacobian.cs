...
namespace ISAAR.MSolve.XFEM.Geometry.CoordinateSystems
{
    class TipJacobian
    {
        ...
        public TipJacobian(double cosa, double sina, double r, double theta)
        {
            ...
            jacobian[0, 0] = cosa * cosTheta + sina * sinTheta / r;
            jacobian[0, 1] = cosa * sinTheta - sina * cosTheta / r;
            jacobian[1, 0] = sina * cosTheta - cosa * sinTheta / r;
            jacobian[1, 1] = sina * sinTheta + cosa * cosTheta / r;
        }

        public Tuple<double, double> TransformLocalPolarCoordinatesToGlobalCartesian(
