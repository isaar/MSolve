...
namespace ISAAR.MSolve.XFEM.Output.VTK
{
    ...
    /// </summary>
    public class VtkFileWriter2D : IDisposable
    {
        ...
        public VtkFileWriter2D(string filePath)
        {
        ...
        internal void WriteMesh(IReadOnlyList<VtkPoint2D> points, IReadOnlyList<VtkCell2D> cells)
        {
