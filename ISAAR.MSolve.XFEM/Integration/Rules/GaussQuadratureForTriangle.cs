...
namespace ISAAR.MSolve.XFEM.Integration.Rules
{
    sealed class GaussQuadratureForTriangle: IIntegrationRule2D
    {
        ...
        public static readonly GaussQuadratureForTriangle Order7Points13 = new GaussQuadratureForTriangle(
            new GaussPoint2D(0.0651301029022, 0.0651301029022, 0.0533472356088 / 2),
            new GaussPoint2D(0.8697397941956, 0.0651301029022, 0.0533472356088 / 2),
            new GaussPoint2D(0.0651301029022, 0.8697397941956, 0.0533472356088 / 2),
            new GaussPoint2D(0.3128654960049, 0.0486903154253, 0.0771137608903 / 2),
            new GaussPoint2D(0.6384441885698, 0.3128654960049, 0.0771137608903 / 2),
            new GaussPoint2D(0.0486903154253, 0.6384441885698, 0.0771137608903 / 2),
            new GaussPoint2D(0.6384441885698, 0.0486903154253, 0.0771137608903 / 2),
            new GaussPoint2D(0.3128654960049, 0.6384441885698, 0.0771137608903 / 2),
            new GaussPoint2D(0.0486903154253, 0.3128654960049, 0.0771137608903 / 2),
            new GaussPoint2D(0.2603459660790, 0.2603459660790, 0.1756152576332 / 2),
            new GaussPoint2D(0.4793080678419, 0.2603459660790, 0.1756152576332 / 2),
            new GaussPoint2D(0.2603459660790, 0.4793080678419, 0.1756152576332 / 2),
