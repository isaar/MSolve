...
namespace ISAAR.MSolve.XFEM.CrackGeometry
{
    ...
    {
        IReadOnlyList<CartesianPoint2D> CrackPath { get; }

        //TODO: remove it. It is obsolete and should be handled by ICrackGeometry.InitializeGeometry(PolyLine2D initialCrack)
        void InitializeGeometry(CartesianPoint2D crackMouth, CartesianPoint2D crackTip);
        ...
        //PolarPoint2D ToPolar(NaturalPoint2D point, IReadOnlyList<XNode2D> elementNodes,
