...
{
    public class StructuralStochasticEvaluator_v2 : ISystemRealizer, ISystemResponseEvaluator
    {
        ...
        public StructuralStochasticEvaluator_v2(double youngModulus, IStochasticDomainMapper domainMapper)
        {
            YoungModulus = youngModulus;
            DomainMapper = domainMapper;
        ...
        public double[] Evaluate(int iteration)
        {
            ...
            var provider = new ProblemStructural_v2(currentModel, solver);
            var childAnalyzer = new LinearAnalyzer_v2(currentModel, solver, provider);
            var parentAnalyzer = new StaticAnalyzer_v2(currentModel, solver, provider, childAnalyzer);
