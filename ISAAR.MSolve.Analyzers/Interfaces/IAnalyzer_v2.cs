...
namespace ISAAR.MSolve.Analyzers.Interfaces
{
    ...
    {
        IAnalyzer_v2 ParentAnalyzer { get; set; } // This makes sense for child analyzers only. Could it be done with decorators cleanly?
        IAnalyzer_v2 ChildAnalyzer { get; set; } // Ditto, but this makes sense for parent analyzers only.
