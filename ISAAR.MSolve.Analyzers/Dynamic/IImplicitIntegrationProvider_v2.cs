...
namespace ISAAR.MSolve.Analyzers.Dynamic
{
    public interface IImplicitIntegrationProvider_v2 : IAnalyzerProvider_v2
    {
        ...
        void ProcessRhs(ImplicitIntegrationCoefficients coefficients, ISubdomain_v2 subdomain, IVector rhs);
        ...
        IVector MassMatrixVectorProduct(ISubdomain_v2 subdomain, IVectorView vector); 
        IVector DampingMatrixVectorProduct(ISubdomain_v2 subdomain, IVectorView vector);
    }
}
