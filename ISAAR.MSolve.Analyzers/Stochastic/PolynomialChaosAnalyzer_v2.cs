...
{
    public class PolynomialChaosAnalyzer_v2 : IParentAnalyzer
    {
            ...
            bool shouldFactorizeMatrices)
        {
            ...
            this.matrices = new Dictionary<int, IMatrix>[coefficientsProvider.NoOfMatrices + 1];
        ...
        private void InitializeCoefficientsProvider()
        {
            ...
            foreach (var subdomain in model.Subdomains)
                foreach (var e in subdomain.Elements.Where(e => e.ElementType is IStochasticFiniteElement))
        ...
        private void MakePreconditioners()
        {
            ...
            foreach (var sub in linearSystems)
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    //    factorizedMatrices.Add(new Dictionary<int, SkylineMatrix<double>>());
        ...
        public void BuildMatrices()
        {
            ...
            foreach (var linearSystem in linearSystems.Values)
            {
                SkylineMatrix k = (SkylineMatrix)linearSystem.Matrix;
