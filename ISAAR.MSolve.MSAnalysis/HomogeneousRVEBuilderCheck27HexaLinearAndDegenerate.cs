...
{
    public class HomogeneousRVEBuilderCheck27HexaLinearAndDegenerate : IdegenerateRVEbuilder_v2
    {
        ...
        public HomogeneousRVEBuilderCheck27HexaLinearAndDegenerate()
        {
            //TODOGerasimos
            // this.renumbering_vector_path=renumbering_vector_path,
            // this.subdiscr1=subdiscr1
        }
        public IRVEbuilder_v2 Clone(int a) => new HomogeneousRVEBuilderCheck27HexaLinearAndDegenerate();
