...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    public static class SubdomainCalculationsMultiple_v2
    {
        ...
        public static Dictionary<int, double[]> CalculateFppReactionsVectorSubdomains_v2(Model_v2 model, IElementMatrixProvider_v2 elementProvider,
            IScaleTransitions_v2 scaleTransitions, Dictionary<int, Node_v2> boundaryNodes, Dictionary<int, IVector> solution, Dictionary<int, IVector> dSolution,
        ...
        /// </param>
        public static Dictionary<int, double[][]> CalculateKffinverseKfpDqSubdomains_v2(Dictionary<int, double[][]> KfpDqSubdomains, Model_v2 model, IElementMatrixProvider_v2 elementProvider,
            IScaleTransitions_v2 scaleTransitions, Dictionary<int, Node_v2> boundaryNodes, ISolver_v2 solver)
        {
        ...
        public static Dictionary<int, double[][]> CalculateKpfKffinverseKfpDqSubdomains_v2(Dictionary<int, double[][]> f2_vectorsSubdomains, Model_v2 model, IElementMatrixProvider_v2 elementProvider, IScaleTransitions_v2 scaleTransitions, Dictionary<int, Node_v2> boundaryNodes)
        {
