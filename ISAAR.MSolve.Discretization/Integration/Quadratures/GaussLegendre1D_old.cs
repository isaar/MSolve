...
namespace ISAAR.MSolve.Discretization.Integration.Quadratures
{
    ...
    /// </summary>
    public sealed class GaussLegendre1D_old : IQuadrature1D
    {
        public static readonly GaussLegendre1D_old Order1 = new GaussLegendre1D_old(
            new GaussPoint1D(0.0, 2.0));

        public static readonly GaussLegendre1D_old Order2 = new GaussLegendre1D_old(
            new GaussPoint1D(-0.5773502691896257645091488, 1.0),
            new GaussPoint1D(+0.5773502691896257645091488, 1.0));

        public static readonly GaussLegendre1D_old Order3 = new GaussLegendre1D_old(
            new GaussPoint1D(-0.7745966692414833770358531, 0.5555555555555555555555556),
            new GaussPoint1D(0.0, 0.8888888888888888888888889),
            new GaussPoint1D(+0.7745966692414833770358531, 0.5555555555555555555555556));

        public static readonly GaussLegendre1D_old Order4 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order5 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order6 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order7 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order8 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order9 = new GaussLegendre1D_old(
        ...
        public static readonly GaussLegendre1D_old Order10 = new GaussLegendre1D_old(
        ...
        private GaussLegendre1D_old(params GaussPoint1D[] points)
        {
