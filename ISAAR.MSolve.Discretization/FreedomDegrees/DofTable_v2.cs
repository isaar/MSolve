...
namespace ISAAR.MSolve.Discretization.FreedomDegrees
{
    ...
    public class DofTable_v2: Table<INode, DOFType, int>
    {
        public DofTable_v2(): base()
        { }

        private DofTable_v2(Dictionary<INode, Dictionary<DOFType, int>> data): base(data)
        { }

        //TODO: this would be nice to have in Table too.
        public DofTable_v2 DeepCopy()
        {
            ...
            return new DofTable_v2(dataCopy);
        }
