...
namespace ISAAR.MSolve.LinearAlgebra.Tests.LinearSystems
{
    ...
    public static class MinResTests
    {
        ...
        private static void TestIndefiniteSystem()
        {
            ...
            var minres = new MinimumResidual(A.NumRows, residualTolerance, () => Vector.CreateZero(b.Length), 0, false, false);
        ...
        private static void TestPosDefDenseSystem()
        {
            ...
            var minres = new MinimumResidual(n, 1e-10, () => Vector.CreateZero(b.Length), 0, false, false);
            (IVector xComputed, MinresStatistics stats) = minres.Solve(A, b);
            comparer.AssertEqual(xExpected, xComputed);
        }
