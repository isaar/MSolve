...
namespace ISAAR.MSolve.LinearAlgebra.Iterative.ResidualUpdate
{
    ...
    {
        internal static IVector Calculate(ILinearTransformation_v2 matrix, IVectorView rhs, IVectorView solution)
        {
        ...
        internal static void Calculate(ILinearTransformation_v2 matrix, IVectorView rhs, IVectorView solution, IVector residual)
        {
