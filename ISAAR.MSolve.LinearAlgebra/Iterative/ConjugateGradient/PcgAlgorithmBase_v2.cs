...
namespace ISAAR.MSolve.LinearAlgebra.Iterative.ConjugateGradient
{
    ...
    /// </summary>
    public abstract class PcgAlgorithmBase_v2
    {
        protected readonly IMaxIterationsProvider maxIterationsProvider;
        protected readonly double residualTolerance;
        protected readonly IPcgConvergenceStrategy convergence;
        protected readonly IResidualCorrection residualCorrection;

        protected PcgAlgorithmBase_v2(double residualTolerance, IMaxIterationsProvider maxIterationsProvider,
            IPcgConvergenceStrategy convergence, IResidualCorrection residualCorrection)
        {
