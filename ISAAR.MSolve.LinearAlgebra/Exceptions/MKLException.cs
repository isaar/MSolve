...
namespace ISAAR.MSolve.LinearAlgebra.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MklException"/> class.
        /// </summary>
        public MklException()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="MklException"/> class with a specified error message.
        /// </summary>
