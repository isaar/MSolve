...
namespace ISAAR.MSolve.SamplesConsole
{
    public class PresentationTests
    {
        ...
        public void Solve4QuadProblem()
        {
            ...
            #region elements
            var element0 = new Element_v2 { ID = 0, ElementType = new Quad4_v2(material) };
            element0.AddNodes(new[] { node0, node1, node4, node3 });

            var element1 = new Element_v2 { ID = 1, ElementType = new Quad4_v2(material) };
            element1.AddNodes(new[] { node1, node2, node5, node4 });

            var element2 = new Element_v2 { ID = 2, ElementType = new Quad4_v2(material) };
            element2.AddNodes(new[] { node3, node4, node7, node6 });

            var element3 = new Element_v2 { ID = 3, ElementType = new Quad4_v2(material) };
