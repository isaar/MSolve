...
{
    internal abstract class SubdomainGlobalConversionBase : ISubdomainGlobalConversion
    {
        protected readonly IStructuralModel_v2 model;
        protected readonly DofSeparator dofSeparator;

        protected SubdomainGlobalConversionBase(IStructuralModel_v2 model, DofSeparator dofSeparator)
        {
            this.model = model;
